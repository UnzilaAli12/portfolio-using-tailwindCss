...
<div className='mt-10 text-left' >
<h2 className='text-3xl font-bold text-gray-900 text-center' >Skills & Expertise</h2>
<ul className='mt-6 space-y-4 text-lg text-gray-700 grid grid-col-2 gap-1' >
<li>✅ Frontend Development (Next.js, React, TypeScript)</li>
          <li>✅ UI/UX Design (Adobe XD, Figma, Photoshop, Illustrator)</li>
          <li>✅ Responsive Web Design (Tailwind CSS, CSS3, HTML5)</li>
          <li>✅ API Integration & Data Fetching (RESTful APIs, GraphQL)</li>
          <li>✅ State Management (Redux, Context API)</li>
          <li>✅ E-commerce Platforms (Shopify, Amazon, eBay)</li>
          <li>✅ Cloud & AI (Currently studying Full Stack AI Engineering)</li>
