...
const Header = () => {
      return (
        ...
        <header className='w-full bg-gray-900 text-white py-4 px-2 md:px-6 fixed shadow-md ' >
<div className=' mx-auto flex items-center justify-between text-3xl font-bold ' >
